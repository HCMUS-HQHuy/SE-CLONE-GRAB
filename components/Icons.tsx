...
export const MotorcycleIcon: React.FC<IconProps> = ({ className }) => (
    /* FIX: Added missing closing brace '}' for strokeWidth and separated path numbers with spaces for clarity */
...
export const TruckIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path d="M9 17a2 2 0 11-4 0 2 2 0 014 0zM19 17a2 2 0 11-4 0 