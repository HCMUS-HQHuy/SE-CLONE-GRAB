...
const RestaurantPendingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-white rounded-xl shadow-lg p-8 text-center">
        <div className="mx-auto h-16 w-16 flex items-center justify-center rounded-full bg-orange-100 text-orange-600 mb-4">
        ...
        <p className="text-gray-600 mt-3">
          Cảm ơn bạn đã đăng ký trở thành đối tác. Hồ sơ của bạn đang được chúng tôi xem xét.
        </p>
        <div className="mt-6 bg-yellow-50 border border-yellow-200 p-4 rounded-lg flex items-center justify-center space-x-3">
            ...
            <p className="text-sm font-medium text-yellow-800">
                Quá trình xét duyệt có thể mất từ 1-3 ngày làm việc. Chúng tôi sẽ thông báo cho bạn qua email khi hoàn tất.
            </p>
        </div>
